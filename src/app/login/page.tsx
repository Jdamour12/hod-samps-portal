...
export default function HODLogin() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            // Login with HOD role specification
            ...
            // Set HOD session
            localStorage.setItem("hod_logged_in", "true");
            ...
            setError(
                ...
                "Invalid credentials. Please verify your HOD credentials and try again."
            );
        } finally {
            setIsLoading(false);
        }
    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-white to-blue-50 relative">
            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8 flex flex-col items-center mt-40">
                ...
                <p className="text-sm text-gray-600 mb-4 text-center">
                    Access departmental management tools
                </p>
                ...
                <div className="mt-6 text-center text-sm text-gray-500">
                    <p className="mb-2">Sign in as different role:</p>
